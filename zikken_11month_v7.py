...
NOVEL_CATALOG = {
    "shadow": {
        ...
        "summary": """主人公シドは幼い頃から「陰の実力者」に憧れ、現代日本で格闘技や怪しい修行に明け暮れるが、トラックに轢かれてあっさり死亡し、魔力のある異世界の貴族カゲノー家に転生する。今度こそ陰の実力者になるべく、表では凡庸なモブ少年を演じつつ、裏で魔力と剣技を極限まで鍛え、スライム製ボディスーツや変形剣を開発して盗賊団を虐殺、資金と実験材料を集める。その過程で肉塊となっていた金髪エルフ少女アルファを救い、でっち上げの「ディアボロス教団」と「魔人ディアボロスの呪い」の神話を語って組織シャドウガーデンを設立、アルファやベータ、ガンマら元悪魔憑き達が本気でそれを信じて世界規模の秘密結社に育ててしまう。数年後、シドの姉クレアが教団に攫われる事件が起き、シャドウとなった彼はアルファ達と共に地下施設を急襲、覚醒薬で怪物化したオルバ子爵を圧倒的な技量と奥義「アイ・アム・アトミック」で消し飛ばす。その後シドは王都の魔剣士学園に入り、ツンデレ王女アレクシアに罰ゲーム告白からまさかの交際を申し込まれ、婚約者候補のゼノンとの駆け引きに巻き込まれる。やがてアレクシア誘拐事件が再び発生し、教団の実験施設、化物化した被験者、ゼノンのラウンズ入りの野望などが交錯、アルファやアイリス王女もそれぞれ別戦場で怪物と激突する中、シャドウが放った「アトミック」によってアジトごとゼノンは蒸発する。表向きはアーティファクト暴走として処理され、シドとアレクシアは関係を解消。裏ではガンマがシドの前世知識をもとにミツゴシ商会を巨大企業へ育て、チョコレートや化粧品で資金と影響力を拡大しつつ、教団のチルドレンやシャドウを騙る黒装束の偽者をニューらが拷問して始末する。一方で学術学園では天才研究者シェリーと義父ルスランが教団由来のアーティファクト解析に乗り出し、アイリスとアレクシアは紅の騎士団を軸に教団とシャドウガーデン、どちらが真の敵なのか探り始める。"""
    },
    "kabi": {
        "title": "黴",
        "file": "kabi_text.json",
        "summary": """主人公笹村は、放浪気味の下宿暮らしと胃弱に疲れ、旅先で友人の家庭や兄夫婦を見て「自分も世帯を持とう」と思い立ち、友人Ｋの建てた新開地の長屋に入る。最初は友人深山やＴと同居めいた形で始まり、老女中と、その娘のお銀が出入りして炊事を受け持つようになる。お銀には、深山の親戚筋の年増に恋人を奪われた過去や、縁談から逃げて来た経緯があり、やがて笹村と曖昧な同棲関係になっていく。この過程で深山との関係はぎくしゃくし、彼は別家を構えて去り、周囲の文人仲間や家主Ｋもそれぞれ口を挟んで、噂と干渉が笹村を追いつめる。

お銀の妊娠が判ると、堕胎や里子の案まで具体的に相談され、笹村は俳友Ｂに打ち明けて「女を処分して身軽になれ」とまで諭される。一方で、若い頃から敬愛してきた文壇の師Ｍ先生が胃癌で入院し、笹村は翻訳仕事を引き受けて牛込の下宿に移るが、金は乏しく、仕事は重く、妻子を持つ資格が自分にあるのかという劣等感と病への恐怖も重なって、家と病院と下宿のあいだをさまよい続ける。

結局お銀は京橋の知人宅に身を寄せる計画を取りやめ、貧しい長屋のまま出産の日を迎える。難産の末、産婆の奮闘で女の子だったか男の子だったか、まだ頼りないが一応「人並み」の赤ん坊が生まれ、瀕死のように衰弱したお銀は辛うじて一命を取りとめる。笹村は子を他家にやる案と情のあいだで揺れながらも、裏庭で抱き上げた幼子の顔に奇妙な愛着と哀れみを覚え、明確な決断を先送りにしたまま、師の病状悪化、甥の素行不良、未完の原稿と借金、新しい家探しといった現実に押し流されていくところで物語は終盤に差しかかっていたように思う。"""
    },
    "novel3": {
        "title": "仮小説３",
        "file": "novel3_text.json",
        "summary": "これは仮の小説3の要約です。実際の小説データが用意されるまでのプレースホルダーテキストです。"
    },
    "novel4": {
        "title": "仮小説４",
        "file": "novel4_text.json",
        "summary": "これは仮の小説4の要約です。実際の小説データが用意されるまでのプレースホルダーテキストです。"
    },
    "novel5": {
        "title": "仮小説５",
